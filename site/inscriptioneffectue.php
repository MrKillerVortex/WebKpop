<html>
    <head>
        <meta charset="utf-8">
        <title>Un page qui confirme l'inscription sur le site</title>
    ...
    <body>
        ...
        <div id="MainBienvenue">
            <img id="Bienvenue" src="Bienvenue.png">
            <h2> Ravi de vous avoir sur le site !</h2>
            <p> 
                Vous êtes maintenant inscrit et vous pouvez vous connecter sur le site web !
            </p>
